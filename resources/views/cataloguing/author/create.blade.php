...
<form method="POST" action="{{route('book.create')}}" class="w-full p-4 md:p-5">
    ...
    <div class="grid gap-4 mb-4 grid-cols-4">
        ...
        <div class="col-span-4">
            <label for="accession_number" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Accession
                Number</label>
        ...
        <div class="col-span-1">
            <label for="cutter_number" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Cutter
                Number</label>
        ...
        <div class="col-span-2">
            <label for="copies" class="block mb-2 text-sm font-medium te xt-gray-900 dark:text-white">Copies</label>
