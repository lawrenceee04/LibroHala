...
<aside id="logo-sidebar"
    ...
    <nav class="flex flex-col justify-between h-full">
        <nav class="flex flex-col">
            ...
            <a href="#" class="px-6 py-3 cursor-not-allowed text-gray-300">Cataloguing</a>
            <button type="button"
                    class="px-6 py-3 text-start flex flex-row items-center gap-4 cursor-not-allowed text-gray-300"
        ...
        <div>
            ...
            <button form="logout" class="w-full text-start px-6 py-3 font-semibold text-red-500 hover:text-white hover:font-bold hover:bg-red-500">
